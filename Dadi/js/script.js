...
const insertName = document.getElementById("insertName"); // Richiamo il pulsante reset 
...
check.addEventListener("click", function () {
    ...
    let stringUser = "";
    for (let i = 1; i <= 20; i++) { //genero 20 numeri casuali per creare l'animazione dei dati, l'ultimo numero casuale sarà anche quello dell'utente
    ...
    let percentualePc = 0;
    let stringPc = "";
    for (let i = 1; i <= 20; i++) { //genero 20 numeri casuali per creare l'animazione dei dati, l'ultimo numero casuale sarà anche quello del pc
...
reset.addEventListener("click", function () { // in caso l'utente clicca il pulsante reset resetto la pagina
    ...
    document.getElementById("dado-utente").innerHTML = `<div class="m-3 dado-1 "></div> `;// imposto dato uno per la partenza
    document.getElementById("dado-pc").innerHTML = `<div class="m-3 dado-1 "></div> `; // imposto dato uno per la partenza
    document.getElementById("dado-nome-utente").innerHTML = "Questo è il dado di Utente anonimo"; // Iposto nome di partenza
